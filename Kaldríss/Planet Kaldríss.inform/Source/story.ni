...
[
- Examine Befehle einfügen
- Take Befehle einfügen
- rock formation polishing
- follow mechanik ggf. anpassen (nur zwischen bestimmten räumen bewegen und nicht random)
- prevent descriptions from being printed (e.g. Pillars)
- prevent character descriptions from being printed (only if examined)
]
