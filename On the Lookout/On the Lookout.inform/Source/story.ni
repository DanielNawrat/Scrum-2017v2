...
The Spaceship_Geysiria is a room. The printed name is "Spaceship Geysiria". 
"The airlock also seems to be affected by the crash and the temperatures inside the spaceship are nearing dangerous levels." 
The Spaceship Exit_Geysiria is a room.

Instead of going west from the Spaceship Bridge_Geysiria, say "The key to leave the spaceship is going south."
Instead of going west from the Spaceship Storage_Geysiria, say "The key to leave the spaceship is going south."
Instead of going east from the Spaceship Bridge_Geysiria, say "The key to leave the spaceship is going south."
Instead of going east from the Spaceship Storage_Geysiria, say "The key to leave the spaceship is going south."
Instead of going north, say "The key to leave the spaceship is going south."
Instead of going west from the Spaceship Exit_Geysiria, say "Really? You want to dive into those massive waves? How long can you hold your breath? I'm not too sure if that's a good idea... Think again."
Instead of going north from the Landing Zone_Geysiria, say "A massive crater is in front of you. No tools you have at hand will help you to cross this crater as you don't have enough water and food to go through it."


The printed name of the Spaceship Exit_Geysiria is "Spaceship Exit". 
"Bye Spaceship. Let's go and have a look around. There's more to this planet than ash clouds, lava and rocky landscape if you use your knowledge and cleverness. On the western side you see massives waves detonating on the shores. You turn around and you see a vastland of volcanoes, mountains and dry land. This must be the vast landscape of Geysiria."
...
>>>>>>> 842cca31b8590f502acf08e8c6249ca0ab102d0b
